  ...
  <div class="container" style="width:800px;background-color:white;height:600px;margin-top:70px">
	<div class="" style="background-color:#F0F5F8;height:50px">
		...
		<div style="padding-top:10px">
			<span style="font-size:20px;">编辑<strong> <a href="">${contact.name}</a> </strong>的事件 </span>  
		</div>
	...
	<div class="main" style="">
		<div class="container" style="margin-left:20px;margin-top:20px;width:735px">
			<form id="form" action="updateContactEvent.action" method="post">
				<input type="hidden" name="contact_id" value="${contact.id}"/> 
				<input type="hidden" name="contacteventid" value="${contactEvent.id}"/> 
				<textarea name="contactEventInfo" id="info" style="width:735px" rows="4">${contactEvent.info}</textarea>
				<br />
				
				<button id="btn" class="btn btn-primary pull-right">保存修改</button>
				<a href="tocontact.action?contact_id=${contact.id}" class="btn pull-right" style="margin-right:10px">取消</a>
			</form>
