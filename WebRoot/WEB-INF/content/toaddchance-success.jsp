...
<body class="well">
  ...
  <div class="container" style="width:800px;background-color:white;margin-top:70px">
	...
	<form class="form-horizontal" action="addchance.action" method="post" id="form">
        <fieldset>
		  ...
		  <div class="control-group">
            ...
            <div class="controls">
              <label class="radio">
                <input type="radio" value="all" checked="checked" id="optionsRadios1" name="optionsRadios"/>
                	所有同事
              </label>
              <label class="radio">
                <input type="radio" value="me" id="optionsRadios2" name="optionsRadios"/>
               		只有我自己
              </label>
            </div>
          </div>
		...
		<div class="form-actions container" style="width:500px">
            ...
            <a href="chance.action" class="btn">取消</a>
          </div>
      </form>
  </div>
